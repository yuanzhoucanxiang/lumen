...
const PATHS = {
  ...
  pointer: (
    <>
      <path d="M6 3.5 17 10l-5.2 1.6L8.6 17.5z" />
      <path d="m14.5 13.5 3.6 5.4" />
    </>
  ),
  /* 白板工具：手绘笔 */
  penTool: <path d="M4 20c1-7 3.5-10.5 6-10.5s3.8 3.8 5.6 3.8 3.4-3 4.4-5.3" strokeLinecap="round" />,
  /* 白板工具：箭头 */
  arrow: (
    <>
  ...
  /* 白板工具：椭圆 */
  circle: <ellipse cx="12" cy="12" rx="8.5" ry="5.5" />,
  /* 白板：重做 */
  redo: (
    <>
      <path d="M15.5 14 20 9.5 15.5 5" />
      <path d="M20 9.5H10a5.5 5.5 0 0 0 0 11h3.5" />
    </>
  ),
  /* 白板：适配全部内容 */
  fit: (
